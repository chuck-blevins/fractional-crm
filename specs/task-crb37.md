# CRB-37 — UI: CSV import / export

**Linear:** [CRB-37](https://linear.app/crbc/issue/CRB-37/ui-csv-import-export)

**Phase 4. Depends on: CRB-30, CRB-32.**
...
- Annotation + `docs/worklog/CRB-37.md` per conventions.
