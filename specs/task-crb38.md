# CRB-38 — Remove Python app; rewrite docs for the web app

**Linear:** [CRB-38](https://linear.app/crbc/issue/CRB-38/remove-python-app-rewrite-docs-for-the-web-app)

**Phase 5 (cleanup). Depends on: all prior stories reaching parity.**

Once CRB-22…CRB-37 have ported and verified every behavior, remove the Python implementation so
...
- Cross-check the parity table in `docs/worklog/CRB-38.md` (module → TS location → test file).
...
- `docs/worklog/CRB-38.md`: the full parity table + confirmation the suites pass.
