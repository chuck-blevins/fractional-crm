# CRB-19 — Scaffold Next.js + TypeScript + tooling
...
existing Python code (which stays until CRB-37). This is the base every later story builds on.
...
- Annotation + `docs/worklog/CRB-19.md` per conventions. Update `.agent/conventions.md` is
